            ...
            <div>
                ...
                <div className="project-img">
                    <div className="container">
                            <br/><br/>
                            <div className="row">
                                <video id="bg-video2" className="w-100 wow fadeInUp" data-wow-delay="2s" controls controlsList="nodownload" disablePictureInPicture poster={poster} style={{outline:'none'}}>
